...
export function QuranPage({ verses, isLoading, currentPage, userPreferences, playVerseInMainPlayer, highlightedVerse, layoutMode, fontSize, arabicFont, allChapters }: QuranPageProps) {
